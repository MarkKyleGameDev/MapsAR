...
namespace Mapbox.MapboxSdkCs.UnitTest
{
	...
	internal class MapMatcherTest
	{
		...
		public IEnumerator Profiles()
		{
			...
			Assert.GreaterOrEqual(matchingResponse.Matchings[0].Duration, 80, "'driving-traffic' duration less than expected");
			...
			Assert.GreaterOrEqual(matchingResponse.Matchings[0].Duration, 80, "'driving' duration less than expected");
		}
		...
		public IEnumerator OverviewSimplified()
		{
			...
			Assert.GreaterOrEqual(matchingResponse.Matchings[0].Geometry.Count, 13, "Wrong number of vertices in match geometry");
		}
